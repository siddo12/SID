...
$working_key = 'AA8A258F51B7F5600AA91125CE0F1BEB';

// Provide access code Shared by CCAVENUES
$access_code = 'AVLS02DA32AL69SLLA';
...
$merchant_json_data = array(
    'si_sub_ref_no' => '112040222681',
    'si_mer_charge_ref_no' => '',
    'si_currency' => '',
    'si_amount' => ''
);
...
$final_data = "request_type=JSON&access_code=" . $access_code . "&command=chargeSI&version=1.1&response_type=JSON&enc_request=" . $encrypted_data;
