...
<html lang="en">
 <head>
  ...
  <title>API</title>
  <h1>Cancel</h1>
  <p>Cancel API call allows you to cancel a pending order. An order older than 7 days is automatically
cancelled. Once an order has been cancelled/auto-cancelled by the system, it cannot be confirmed.
Funds will be refunded to the credit card or debit card or net banking account that was originally
charged.</p>
 </head>
 <body>
...
'order_List' =>
    ...
    $final_data = "request_type=JSON&response_type=JSON&access_code=".$access_code."&command=cancelOrder&version=1.1&enc_request=" . $encrypted_data;
