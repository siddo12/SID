...
<html lang="en">
 <head>
  ...
  <title>API</title>
  <h1>Standing Instruction Charge</h1>
  <p>The SI charge API call allows you to charge a customer registered for standing instruction.</p>
 </head>
 <body>
  <form action="<?php $_SERVER["PHP_SELF"]; ?>" name="form1" method="post"> 
 <table>
 
 <tr><td>Standing Instruction ID :</td> <td><input type ="text" name ="si_sub_ref_no"></td></tr>
 <tr><td>Merchant Charge Reference Number :</td> <td><input type ="text" name ="si_mer_charge_ref_no"></td></tr>
 <tr><td>Amount :</td> <td><input type ="text" name ="si_amount"></td></tr>
 <tr><td>Currency :</td> <td><input type ="text" name ="si_currency"></td></tr>
...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $merchant_json_data =
        ...
        'si_sub_ref_no' => $_POST ["si_sub_ref_no"],
        'si_mer_charge_ref_no' => $_POST ["si_mer_charge_ref_no"],
        'si_amount' => $_POST ["si_amount"],
        'si_currency' => $_POST ["si_currency"],
    );

    $merchant_data = json_encode($merchant_json_data);
    $encrypted_data = encrypt($merchant_data, $working_key);
    $final_data = "request_type=JSON&response_type=JSON&access_code=".$access_code."&command=chargeSI&version=1.1&enc_request=" . $encrypted_data;
