...
<html lang="en">
 <head>
  ...
  <title>API</title>
  <h1>Bank Identification Number</h1>
  <p>Bin Details call is performed to fetch the card details of bin.</p>
 </head>
 <body>
  <form action="<?php $_SERVER["PHP_SELF"]; ?>" name="form1" method="post"> 
 <table>
 
 <tr><td>Bank Identification Number :</td> <td><input type ="text" name ="bin_number"></td></tr>
...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $final_data = "request_type=JSON&response_type=JSON&access_code=".$access_code."&command=binDetails&version=1.1&enc_request=" . $encrypted_data;
